...
public class ThomasEmanuelBermudezMora_Bono1_Tarea3 {
    static BufferedReader in = new BufferedReader(new InputStreamReader(System.in));
    static PrintStream out = System.out;

    public static void main(String[] args) throws Exception {
        //Variables de entrada
        int nivelEstudiante, opcionEquipo, opcionBeca;
        boolean esContinuando = true;
        ...
        int cantidadEstudiantes = 0, totalEstudiantesBaloncesto = 0, totalEstudiantesNatacion = 0, totalEstudiantesAjedrez = 0, totalEstudiantesSinEquipo = 0;
        ...
        do {
            ...
            esContinuando = "SI".equalsIgnoreCase(in.readLine());
        ...
        out.println("\nTotal de estudiantes que respondieron la encuesta: "+cantidadEstudiantes);
        out.println("Total de estudiantes que respondieron la encuesta por nivel:");
